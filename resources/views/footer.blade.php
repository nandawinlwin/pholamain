...
<div class="about">
    ...
    <div class="social-media">
        <ul class="list-inline">
            <li><a href="http://www.nextbootstrap.com/" title=""><i class="fab fa-facebook-square"></i></a></li>
            <li><a href="http://www.nextbootstrap.com/" title=""><i class="fab fa-twitter-square"></i></a></li>
            <li><a href="http://www.nextbootstrap.com/" title=""><i class="fab fa-google-plus-square"></i></a></li>
        </ul>
    </div>
</div>
</div>
...
<div class="row">
<div class="col-sm-6">
<p>Copyright © 2018. Pho La Min Property.</p>
</div>
<div class="col-sm-6"></div>
    ...
    <script src="<?php echo url(''); ?>/front-end/js/jquery.js"></script>
    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo url(''); ?>/front-end/js/bootstrap.min.js"></script>
