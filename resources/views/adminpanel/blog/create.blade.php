            ...
            <div class="row">
                ...
                <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="pull-left"> Blog Posts Create </h3><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content_zg" id="content_zg" class="form-control" id="" cols="30" rows="20"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content_un" id="content_un" class="form-control" id="" cols="30" rows="20"></textarea>
                                        </div>
                                    </div>
